...
public enum ErrorResponseMessages implements ResponseMessages {
    ...
    PHONE_NUMBER_ALREADY_EXIST(
            "phone_number_already_exist", "Phone number already exist", HttpStatus.CONFLICT
    ),
    ...
    STUDENT_ALREADY_ADDED_TO_GROUP(
            "student_already_added_to_group", "Student is already added to group", HttpStatus.CONFLICT
    ),
